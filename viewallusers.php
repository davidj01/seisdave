...
<?php
  ...
  $query = "SELECT user_id, first_name, picture FROM users WHERE first_name IS NOT NULL ORDER BY join_date DESC";
  ...
  while ($row = mysqli_fetch_array($data)) {
    ...
    if (isset($_SESSION['user_id'])) {
      echo '<td><a href="viewprofile.php?user_id=' . $row['user_id'] . '">' . $row['first_name'] . '</a><br /><br /><a href="addfriend.php?user_id=' . $row['user_id'] . '">Add Friend</a></td></tr>';
    }
    else {
